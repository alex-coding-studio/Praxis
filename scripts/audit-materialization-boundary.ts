...
export const MATERIALIZATION_REQUIRED_FILES = [
  ...
  'lib/graph/proposal/run-state.ts',
  ...
  'lib/graph/proposal/pending.ts',
  'lib/graph/proposal/module-runtime.ts',
  'lib/graph/run-evidence.ts',
  ...
  'lib/modules/module-instructions.ts',
  'lib/modules/product-discovery/acceptance.ts',
  'lib/modules/product-discovery/discard.ts',
  'lib/modules/product-discovery/run-store.ts',
  'lib/modules/product-discovery/harness-result.ts',
  'lib/modules/scope-decomposition/contract.ts',
  'lib/modules/scope-decomposition/assembly.ts',
  ...
  'lib/modules/scope-decomposition/acceptance.ts',
  'lib/modules/scope-decomposition/discard.ts',
  'lib/modules/scope-decomposition/run-store.ts',
  'lib/modules/scope-decomposition/harness-result.ts',
  ...
  'lib/mcp/project-setup.ts',
  'lib/mcp/prepare-domain-model.ts',
  'lib/mcp/submit-domain-model.ts',
  'lib/mcp/server.ts',
  'lib/mcp/submit.ts',
  'lib/mcp/submit-scope-decomposition.ts',
  'lib/mcp/tool-schemas.ts',
  'lib/mcp/uri.ts',
  'lib/mcp/prepare-delivery-map.ts',
  'lib/mcp/submit-delivery-map.ts',
  'lib/mcp/publication-boundary.ts',
  'lib/mcp/accept.ts',
  'lib/mcp/discard.ts',
  'lib/mcp/instructions.ts',
  'lib/modules/delivery-planning/evidence.ts',
